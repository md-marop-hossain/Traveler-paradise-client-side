        ...
        <div class="review-bg">
            <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
                <div class="w-full text-center pb-8">
                    ...
                    <p class="text-gray-400 font-normal text-base">We have served a significant number of people throughout our whole journey. These are what few of our happay clients said about us.</p>
                </div>
                <div class="w-full grid grid-cols-1 md:grid-cols-3 sm:grid-cols-1 gap-6">
                    {
...
// </div>
// <div>
//     <p class="text-gray-400 leading-loose font-normal text-base">We expected a lot of fun gliding along the lake or on the trails. We didn't expect the thrill we'd get over getting over obstacles, going down hills and cutting through the woods along the scenic river rapids. But, it was those things that made the experience extra awesome and memorable.</p>
// </div>
// </div>
// <div class="bg-white rounded-lg p-6">
// <div class="flex items-center space-x-6 mb-4">
...
// </div>
// <div>
//     <p class="text-gray-400 leading-loose font-normal text-base">Our guide had an inner sense of what we could and could not do. She knew exactly how to support, guide, lead and enable each of us to experience the maximum benefit from this trip. I cannot say enough positive things about this amazing young woman. She is wise way beyond her years, and without her, our experience would have been much less positive.</p>
// </div>
// </div>
// <div class="bg-white rounded-lg p-6">
// <div class="flex items-center space-x-6 mb-4">
